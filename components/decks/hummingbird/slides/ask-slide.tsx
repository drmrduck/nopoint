const FACTS = [
    { label: 'Round', value: '$2M seed' },
    { label: 'Valuation', value: '$14M post' },
    { label: 'Runway', value: '24 months' },
]

const USE = [
    { pct: '55%', bucket: 'Engineering' },
    { pct: '30%', bucket: 'Developer GTM' },
...
export function AskSlide() {
    return (
        <div className="flex h-full w-full bg-zinc-950 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tl from-emerald-500/6 via-transparent to-transparent pointer-events-none" />
            ...
            <div className="flex flex-col justify-center px-24 w-full relative z-10">
                ...
                <h2 className="font-headline text-8xl font-semibold text-white tracking-tight leading-tight mb-12">
                    Raising <span className="text-emerald-400">$2M</span>
                </h2>
                ...
                <p className="text-lg text-white/45 mt-14">
                    jamie@hummingbird.dev · let&apos;s talk.
                </p>
            </div>
        </div>
    )
